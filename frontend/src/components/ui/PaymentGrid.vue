                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="IsCompleted">{{ val.isCompleted }}</td>
                            <td class="whitespace-nowrap" label="ExternalPaymentModule">
                                <ExternalPaymentModuleId :editMode="editMode" v-model="val.externalPaymentModuleId"></ExternalPaymentModuleId>
                            </td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Boolean label="IsCompleted" v-model="selectedRow.isCompleted" :editMode="true"/>
